...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Column transformations complete...")
            return preprocessor
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Preprocessing Testing and Training data...")
            input_feature_train_array = preprocessor_obj.fit_transform(
                input_feature_train_df)
            input_feature_test_array = preprocessor_obj.transform(
                input_feature_test_df)

            train_arr = np.c_[input_feature_train_array,
